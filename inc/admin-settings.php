        ...
        <div class="purelyst-admin-wrap">
            ...
            <main class="purelyst-admin-main">
                <div class="purelyst-admin-container">
                    ...
                    <!-- GitHub Open Source Block -->
                    <div class="purelyst-github-block">
                        <div class="purelyst-github-inner">
                            <svg class="purelyst-github-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="currentColor">
                            ...
                            <div class="purelyst-github-content">
                                <p class="purelyst-github-text">
                                    <?php esc_html_e( 'Purelyst is an open-source WordPress theme, publicly maintained on GitHub.', 'purelyst' ); ?>
                                </p>
                                <p class="purelyst-github-cta">
                                    <?php esc_html_e( 'If you find this theme helpful, please consider supporting the project by leaving a', 'purelyst' ); ?>
                                    <span class="purelyst-star-icon">⭐</span>
                                    <?php esc_html_e( 'star on the repository.', 'purelyst' ); ?>
                                </p>
                            </div>
                            <a href="https://github.com/numanrki/Purelyst" target="_blank" rel="noopener noreferrer" class="purelyst-github-link">
                                <span><?php esc_html_e( 'View on GitHub', 'purelyst' ); ?></span>
